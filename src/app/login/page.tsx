      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 lg:p-24 relative">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-4 mt-10">
            <button className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-rice-deep rounded-lg bg-white text-ink font-bold shadow-sm hover:bg-rice-warm transition-colors focus:ring-2 focus:ring-cinnabar/20 outline-none">
            ...
            <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
              ...
              <button className="w-full py-3 bg-cinnabar text-white rounded-lg font-bold shadow-lg shadow-cinnabar/20 hover:bg-cinnabar-deep hover:shadow-xl transition-all active:scale-[0.98]">
                登录
              </button>
            </form>
          </div>
