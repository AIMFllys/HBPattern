...
export default function PatternNotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] bg-surface px-6 text-center">
      ...
      <h2 className="text-2xl font-bold font-serif text-text mb-2">该纹样档案未找到</h2>
      ...
      <div className="flex gap-4">
        ...
        <Link href="/" className="px-6 py-2 text-text-secondary hover:text-text font-bold transition-colors">
          返回首页
        </Link>
      </div>
    </div>
